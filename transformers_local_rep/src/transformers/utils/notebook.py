...
class NotebookProgressBar:
    ...
    Args:
        ...
        leave (:obj:`bool`, `optional`, defaults to :obj:`True`):
            ...
            :meth:`~transformers_local.utils.notebook.NotebookProgressBar.close` method to make the bar disappear.
        parent (:class:`~transformers_local.notebook.NotebookTrainingTracker`, `optional`):
            A parent object (like :class:`~transformers_local.utils.notebook.NotebookTrainingTracker`) that spawns progress
...
class NotebookTrainingTracker(NotebookProgressBar):
    ...
    Args:
        ...
        column_names (:obj:`List[str]`, `optional`):
            ...
            :meth:`~transformers_local.utils.notebook.NotebookTrainingTracker.write_line` if not set).
    """
...
class NotebookProgressCallback(TrainerCallback):
    """
    A :class:`~transformers_local.TrainerCallback` that displays the progress of training or evaluation, optimized for
