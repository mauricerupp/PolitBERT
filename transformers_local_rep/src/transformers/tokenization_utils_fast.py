...
class PreTrainedTokenizerFast(PreTrainedTokenizerBase):
    ...
    Inherits from :class:`~transformers_local.tokenization_utils_base.PreTrainedTokenizerBase`.
    ...
    def _save_pretrained(
        ...
        specific :meth:`~transformers_local.PreTrainedTokenizerFast._save_pretrained`
        """
