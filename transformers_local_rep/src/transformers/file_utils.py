...
def add_start_docstrings_to_model_forward(*docstr):
    def docstring_decorator(fn):
        class_name = ":class:`~transformers_local.{}`".format(fn.__qualname__.split(".")[0])
...
PT_RETURN_INTRODUCTION = r"""
    Returns:
        ...
        comprising various elements depending on the configuration (:class:`~transformers_local.{config_class}`) and inputs.
...
TF_RETURN_INTRODUCTION = r"""
    Returns:
        ...
        various elements depending on the configuration (:class:`~transformers_local.{config_class}`) and inputs.
...
PT_TOKEN_CLASSIFICATION_SAMPLE = r"""
    Example::
        ...
        >>> from transformers_local import {tokenizer_class}, {model_class}
        >>> import torch
...
def http_user_agent(user_agent: Union[Dict, str, None] = None) -> str:
    ...
    """
    ua = "transformers_local/{}; python/{}".format(__version__, sys.version.split()[0])
    if is_torch_available():
...
class ModelOutput(OrderedDict):
    ...
    .. warning::
        You can't unpack a :obj:`ModelOutput` directly. Use the :meth:`~transformers_local.file_utils.ModelOutput.to_tuple`
