...
class TrainerState:
    """
    A class containing the :class:`~transformers_local.Trainer` inner state that will be saved along the model and optimizer
    when checkpointing and passed to the :class:`~transformers_local.TrainerCallback`.
...
class TrainerControl:
    """
    A class that handles the :class:`~transformers_local.Trainer` control flow. This class is used by the
    :class:`~transformers_local.TrainerCallback` to activate some switches in the training loop.
...
class TrainerCallback:
    ...
    Args:
        args (:class:`~transformers.TrainingArguments`):
            The training arguments used to instantiate the :class:`~transformers_local.Trainer`.
        state (:class:`~transformers.TrainerState`):
            The current state of the :class:`~transformers_local.Trainer`.
        control (:class:`~transformers.TrainerControl`):
            The object that is returned to the :class:`~transformers_local.Trainer` and can be used to make some decisions.
        model (:class:`~transformers_local.PreTrainedModel` or :obj:`torch.nn.Module`):
    ...
    def on_init_end(self, args: TrainingArguments, state: TrainerState, control: TrainerControl, **kwargs):
        """
        Event called at the end of the initialization of the :class:`~transformers_local.Trainer`.
        """
        pass
...
class DefaultFlowCallback(TrainerCallback):
    """
    A :class:`~transformers_local.TrainerCallback` that handles the default flow of the training loop for logs, evaluation
    and checkpoints.
    """
...
class ProgressCallback(TrainerCallback):
    """
    A :class:`~transformers_local.TrainerCallback` that displays the progress of training or evaluation.
    """
...
class PrinterCallback(TrainerCallback):
    """
    A bare :class:`~transformers_local.TrainerCallback` that just prints the logs.
    """
...
class EarlyStoppingCallback(TrainerCallback):
    """
    A :class:`~transformers_local.TrainerCallback` that handles early stopping.
    ...
    This callback depends on :class:`~transformers_local.TrainingArguments` argument `load_best_model_at_end` functionality
    to set best_metric in :class:`~transformers_local.TrainerState`.
    """
