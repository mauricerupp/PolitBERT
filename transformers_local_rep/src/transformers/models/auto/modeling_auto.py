...
AUTO_MODEL_PRETRAINED_DOCSTRING = r"""
        ...
        Args:
            pretrained_model_name_or_path (:obj:`str` or :obj:`os.PathLike`):
                Can be either:
                    ...
                    - A path to a `directory` containing model weights saved using
                      :func:`~transformers_local.PreTrainedModel.save_pretrained`, e.g., ``./my_model_directory/``.
            ...
            config (:class:`~transformers_local.PretrainedConfig`, `optional`):
                Configuration for the model to use instead of an automatically loaded configuration. Configuration can
                be automatically loaded when:

                    - The model is a model provided by the library (loaded with the `model id` string of a pretrained
                      model).
                    - The model was saved using :meth:`~transformers_local.PreTrainedModel.save_pretrained` and is reloaded
            ...
            state_dict (`Dict[str, torch.Tensor]`, `optional`):
                ...
                :func:`~transformers_local.PreTrainedModel.save_pretrained` and
                :func:`~transformers_local.PreTrainedModel.from_pretrained` is not a simpler option.
            ...
            kwargs (additional keyword arguments, `optional`):
                ...
                automatically loaded:
                    ...
                    - If a configuration is not provided, ``kwargs`` will be first passed to the configuration class
                      initialization function (:func:`~transformers_local.PretrainedConfig.from_pretrained`). Each key of
...
class AutoModel:
    ...
    created with the :meth:`~transformers_local.AutoModel.from_pretrained` class method or the
    :meth:`~transformers_local.AutoModel.from_config` class method.
    ...
    def from_config(cls, config):
        ...
        Note:
            ...
            model's configuration. Use :meth:`~transformers_local.AutoModel.from_pretrained` to load the model weights.
        ...
        Examples::
            ...
            >>> from transformers_local import AutoConfig, AutoModel
...
class AutoModelForPreTraining:
    ...
    :meth:`~transformers_local.AutoModelForPreTraining.from_pretrained` class method or the
    :meth:`~transformers_local.AutoModelForPreTraining.from_config` class method.
    ...
    def from_config(cls, config):
        ...
        Note:
            Loading a model from its configuration file does **not** load the model weights. It only affects the
            model's configuration. Use :meth:`~transformers_local.AutoModelForPreTraining.from_pretrained` to load the model
            weights.
        ...
        Examples::
            ...
            >>> from transformers_local import AutoConfig, AutoModelForPreTraining
            >>> # Download configuration from huggingface.co and cache.
            >>> config = AutoConfig.from_pretrained('bert-base-uncased')
...
class AutoModelWithLMHead:
    ...
    language modeling head---when created with the :meth:`~transformers_local.AutoModelWithLMHead.from_pretrained` class
    method or the :meth:`~transformers_local.AutoModelWithLMHead.from_config` class method.
    ...
    .. warning::
        ...
        :class:`~transformers_local.AutoModelForCausalLM` for causal language models,
        :class:`~transformers_local.AutoModelForMaskedLM` for masked language models and
        :class:`~transformers_local.AutoModelForSeq2SeqLM` for encoder-decoder models.
    """
    ...
    def from_config(cls, config):
        ...
        Note:
            Loading a model from its configuration file does **not** load the model weights. It only affects the
            model's configuration. Use :meth:`~transformers_local.AutoModelWithLMHead.from_pretrained` to load the model
            weights.
        ...
        Examples::
            ...
            >>> from transformers_local import AutoConfig, AutoModelWithLMHead
            >>> # Download configuration from huggingface.co and cache.
            >>> config = AutoConfig.from_pretrained('bert-base-uncased')
...
class AutoModelForCausalLM:
    ...
    language modeling head---when created with the :meth:`~transformers_local.AutoModelForCausalLM.from_pretrained` class
    method or the :meth:`~transformers_local.AutoModelForCausalLM.from_config` class method.
    ...
    def from_config(cls, config):
        ...
        Note:
            Loading a model from its configuration file does **not** load the model weights. It only affects the
            model's configuration. Use :meth:`~transformers_local.AutoModelForCausalLM.from_pretrained` to load the model
            weights.
        ...
        Examples::
            ...
            >>> from transformers_local import AutoConfig, AutoModelForCausalLM
            >>> # Download configuration from huggingface.co and cache.
...
class AutoModelForMaskedLM:
    ...
    language modeling head---when created with the :meth:`~transformers_local.AutoModelForMaskedLM.from_pretrained` class
    method or the :meth:`~transformers_local.AutoModelForMaskedLM.from_config` class method.
    ...
    def from_config(cls, config):
        ...
        Note:
            Loading a model from its configuration file does **not** load the model weights. It only affects the
            model's configuration. Use :meth:`~transformers_local.AutoModelForMaskedLM.from_pretrained` to load the model
            weights.
        ...
        Examples::
            ...
            >>> from transformers_local import AutoConfig, AutoModelForMaskedLM
            >>> # Download configuration from huggingface.co and cache.
            >>> config = AutoConfig.from_pretrained('bert-base-uncased')
...
class AutoModelForSeq2SeqLM:
    ...
    :meth:`~transformers_local.AutoModelForSeq2SeqLM.from_pretrained` class method or the
    :meth:`~transformers_local.AutoModelForSeq2SeqLM.from_config` class method.
    ...
    def from_config(cls, config):
        ...
        Note:
            Loading a model from its configuration file does **not** load the model weights. It only affects the
            model's configuration. Use :meth:`~transformers_local.AutoModelForSeq2SeqLM.from_pretrained` to load the model
            weights.
        ...
        Examples::
            ...
            >>> from transformers_local import AutoConfig, AutoModelForSeq2SeqLM
            >>> # Download configuration from huggingface.co and cache.
...
class AutoModelForSequenceClassification:
    ...
    :meth:`~transformers_local.AutoModelForSequenceClassification.from_pretrained` class method or the
    :meth:`~transformers_local.AutoModelForSequenceClassification.from_config` class method.
    ...
    def from_config(cls, config):
        ...
        Note:
            Loading a model from its configuration file does **not** load the model weights. It only affects the
            model's configuration. Use :meth:`~transformers_local.AutoModelForSequenceClassification.from_pretrained` to load
            the model weights.
        ...
        Examples::
            ...
            >>> from transformers_local import AutoConfig, AutoModelForSequenceClassification
            >>> # Download configuration from huggingface.co and cache.
            >>> config = AutoConfig.from_pretrained('bert-base-uncased')
...
class AutoModelForQuestionAnswering:
    r"""
    This is a generic model class that will be instantiated as one of the model classes of the library---with a
    question answering head---when created with the :meth:`~transformers_local.AutoModeForQuestionAnswering.from_pretrained`
    class method or the :meth:`~transformers_local.AutoModelForQuestionAnswering.from_config` class method.
    ...
    def from_config(cls, config):
        ...
        Note:
            Loading a model from its configuration file does **not** load the model weights. It only affects the
            model's configuration. Use :meth:`~transformers_local.AutoModelForQuestionAnswering.from_pretrained` to load the
            model weights.
        ...
        Examples::
            ...
            >>> from transformers_local import AutoConfig, AutoModelForQuestionAnswering
            >>> # Download configuration from huggingface.co and cache.
            >>> config = AutoConfig.from_pretrained('bert-base-uncased')
...
class AutoModelForTableQuestionAnswering:
    ...
    :meth:`~transformers_local.AutoModeForTableQuestionAnswering.from_pretrained` class method or the
    :meth:`~transformers_local.AutoModelForTableQuestionAnswering.from_config` class method.
    ...
    def from_config(cls, config):
        ...
        Note:
            Loading a model from its configuration file does **not** load the model weights. It only affects the
            model's configuration. Use :meth:`~transformers_local.AutoModelForTableQuestionAnswering.from_pretrained` to load
            the model weights.
        ...
        Examples::
            ...
            >>> from transformers_local import AutoConfig, AutoModelForTableQuestionAnswering
            >>> # Download configuration from huggingface.co and cache.
...
class AutoModelForTokenClassification:
    ...
    classification head---when created with the :meth:`~transformers_local.AutoModelForTokenClassification.from_pretrained`
    class method or the :meth:`~transformers_local.AutoModelForTokenClassification.from_config` class method.
    ...
    def from_config(cls, config):
        ...
        Note:
            Loading a model from its configuration file does **not** load the model weights. It only affects the
            model's configuration. Use :meth:`~transformers_local.AutoModelForTokenClassification.from_pretrained` to load
            the model weights.
        ...
        Examples::
            ...
            >>> from transformers_local import AutoConfig, AutoModelForTokenClassification
            >>> # Download configuration from huggingface.co and cache.
            >>> config = AutoConfig.from_pretrained('bert-base-uncased')
...
class AutoModelForMultipleChoice:
    ...
    :meth:`~transformers_local.AutoModelForMultipleChoice.from_pretrained` class method or the
    :meth:`~transformers_local.AutoModelForMultipleChoice.from_config` class method.
    ...
    def from_config(cls, config):
        ...
        Note:
            Loading a model from its configuration file does **not** load the model weights. It only affects the
            model's configuration. Use :meth:`~transformers_local.AutoModelForMultipleChoice.from_pretrained` to load the
            model weights.
        ...
        Examples::
            ...
            >>> from transformers_local import AutoConfig, AutoModelForMultipleChoice
            >>> # Download configuration from huggingface.co and cache.
            >>> config = AutoConfig.from_pretrained('bert-base-uncased')
...
class AutoModelForNextSentencePrediction:
    ...
    :meth:`~transformers_local.AutoModelForNextSentencePrediction.from_pretrained` class method or the
    :meth:`~transformers_local.AutoModelForNextSentencePrediction.from_config` class method.
    ...
    def from_config(cls, config):
        ...
        Note:
            Loading a model from its configuration file does **not** load the model weights. It only affects the
            model's configuration. Use :meth:`~transformers_local.AutoModelForNextSentencePrediction.from_pretrained` to load
            the model weights.
        ...
        Examples::
            ...
            >>> from transformers_local import AutoConfig, AutoModelForNextSentencePrediction
            >>> # Download configuration from huggingface.co and cache.
            >>> config = AutoConfig.from_pretrained('bert-base-uncased')
