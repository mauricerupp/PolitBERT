...
PROPHETNET_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformers_local.ProphetNetConfig`): Model configuration class with all the parameters of the model.
...
class ProphetNetEncoder(ProphetNetPreTrainedModel):
    ...
    word_embeddings  (:obj:`torch.nn.Embeddings` of shape :obj:`(config.vocab_size, config.hidden_size)`, `optional`):
        The word embedding parameters. This can be used to initialize :class:`~transformers_local.ProphetNetEncoder` with
...
class ProphetNetDecoderWrapper(ProphetNetPreTrainedModel):
    """
    This is a wrapper class, so that :class:`~transformers_local.ProphetNetForCausalLM` can correctly be loaded from
