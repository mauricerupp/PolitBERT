...
MPNET_START_DOCSTRING = r"""
    ...
    Args:
        config (:class:`~transformers_local.MPNetConfig`): Model configuration class with all the parameters of the model.
...
MPNET_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`Numpy array` or :obj:`tf.Tensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~transformers_local.MPNetTokenizer`. See
