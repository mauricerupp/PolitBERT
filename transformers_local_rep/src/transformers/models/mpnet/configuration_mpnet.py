...
class MPNetConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformers_local.MPNetModel` or a
    :class:`~transformers_local.TFMPNetModel`. It is used to instantiate a MPNet model according to the specified arguments,
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 30527):
            ...
            :obj:`inputs_ids` passed when calling :class:`~transformers_local.MPNetModel` or
            :class:`~transformers_local.TFMPNetModel`.
