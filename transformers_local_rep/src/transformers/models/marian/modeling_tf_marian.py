...
MARIAN_START_DOCSTRING = r"""
    ...
    Args:
        config (:class:`~transformers_local.MarianConfig`): Model configuration class with all the parameters of the model.
...
MARIAN_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`tf.Tensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~transformers_local.MarianTokenizer`. See
