...
LAYOUTLM_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformers_local.LayoutLMConfig`): Model configuration class with all the parameters of the model.
...
LAYOUTLM_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`transformers_local.LayoutLMTokenizer`. See
        ...
        return_dict (:obj:`bool`, `optional`):
            If set to ``True``, the model will return a :class:`~transformers_local.file_utils.ModelOutput` instead of a
            plain tuple.
"""
