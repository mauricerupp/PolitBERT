...
ENCODER_DECODER_START_DOCSTRING = r"""
    ...
    :meth:`~transformers_local.AutoModel.from_pretrained` function and the decoder is loaded via
    :meth:`~transformers_local.AutoModelForCausalLM.from_pretrained` function. Cross-attention layers are automatically added
    ...
    Parameters:
        config (:class:`~transformers_local.T5Config`): Model configuration class with all the parameters of the model.
...
ENCODER_DECODER_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~transformers_local.PreTrainedTokenizer`. See
        ...
        decoder_input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, target_sequence_length)`, `optional`):
            ...
            :class:`~transformers_local.PretrainedTokenizer`. See :meth:`transformers_local.PreTrainedTokenizer.encode` and
        ...
        return_dict (:obj:`bool`, `optional`):
            If set to ``True``, the model will return a :class:`~transformers_local.file_utils.Seq2SeqLMOutput` instead of a
            plain tuple.
...
class EncoderDecoderModel(PreTrainedModel):
    r"""
    :class:`~transformers_local.EncoderDecoder` is a generic model class that will be instantiated as a transformer
    architecture with one of the base model classes of the library as encoder and another one as decoder when created
    with the :meth`~transformers_local.AutoModel.from_pretrained` class method for the encoder and
