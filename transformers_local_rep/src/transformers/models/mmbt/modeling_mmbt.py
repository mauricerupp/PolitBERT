...
MMBT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformers_local.MMBTConfig`): Model configuration class with all the parameters of the model.
...
MMBT_INPUTS_DOCSTRING = r"""
    Args:
        ...
        input_ids (``torch.LongTensor`` of shape ``(batch_size, sequence_length)``):
            ...
            :class:`~transformers_local.BertTokenizer`. See :meth:`transformers_local.PreTrainedTokenizer.encode` and
