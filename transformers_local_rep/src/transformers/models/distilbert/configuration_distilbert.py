...
class DistilBertConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformers_local.DistilBertModel` or a
    :class:`~transformers_local.TFDistilBertModel`. It is used to instantiate a DistilBERT model according to the specified
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 30522):
            ...
            the :obj:`inputs_ids` passed when calling :class:`~transformers_local.DistilBertModel` or
            :class:`~transformers_local.TFDistilBertModel`.
        ...
        qa_dropout (:obj:`float`, `optional`, defaults to 0.1):
            ...
            :class:`~transformers_local.DistilBertForQuestionAnswering`.
        seq_classif_dropout (:obj:`float`, `optional`, defaults to 0.2):
            The dropout probabilities used in the sequence classification and the multiple choice model
            :class:`~transformers_local.DistilBertForSequenceClassification`.
