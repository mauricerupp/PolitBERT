...
class BlenderbotTokenizer(RobertaTokenizer):
    ...
    :class:`~transformers_local.Blenderbot` is nearly identical to :class:`~transformers_local.RobertaTokenizer` and runs
    ...
    Refer to superclass :class:`~transformers_local.RobertaTokenizer` for usage examples and documentation concerning
    parameters.
    """
    vocab_files_names = {
        "vocab_file": "vocab.json",
