...
class BlenderbotConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformers_local.BlenderbotModel`. It is used
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 50265):
            ...
            the :obj:`inputs_ids` passed when calling :class:`~transformers_local.BlenderbotModel` or
            :class:`~transformers_local.TFBlenderbotModel`.
