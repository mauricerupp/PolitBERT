...
BLENDERBOT_START_DOCSTRING = r"""
    ...
    Args:
        config (:class:`~transformers_local.BlenderbotConfig`): Model configuration class with all the parameters of the model.
...
BLENDERBOT_GENERATION_EXAMPLE = r"""
    Conversation example::
        ...
        >>> from transformers_local import BlenderbotTokenizer, TFBlenderbotForConditionalGeneration
...
BLENDERBOT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`tf.Tensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~transformers_local.BlenderbotTokenizer`. See
