...
class MBartTokenizerFast(XLMRobertaTokenizerFast):
    ...
    :class:`~transformers_local.MBartTokenizerFast` is a subclass of :class:`~transformers_local.XLMRobertaTokenizerFast` and adds
    a new :meth:`~transformers_local.MBartTokenizerFast.prepare_seq2seq_batch`.

    Refer to superclass :class:`~transformers_local.XLMRobertaTokenizerFast` for usage examples and documentation concerning
