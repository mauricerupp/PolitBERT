...
class MBartTokenizer(XLMRobertaTokenizer):
    ...
    :class:`~transformers_local.MBartTokenizer` is a subclass of :class:`~transformers_local.XLMRobertaTokenizer` and adds a new
    :meth:`~transformers_local.MBartTokenizer.prepare_seq2seq_batch`

    Refer to superclass :class:`~transformers_local.XLMRobertaTokenizer` for usage examples and documentation concerning the
