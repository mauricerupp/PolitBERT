...
ROBERTA_START_DOCSTRING = r"""
    ...
    This model inherits from :class:`~transformers_local.FlaxPreTrainedModel`. Check the superclass documentation for the
    ...
    Parameters:
        config (:class:`~transformers_local.RobertaConfig`): Model configuration class with all the parameters of the
...
# Copied from transformers_local.models.bert.modeling_flax_bert.FlaxBertLayerNorm with Bert->Roberta
...
# Copied from transformers_local.models.bert.modeling_flax_bert.FlaxBertEmbedding with Bert->Roberta
