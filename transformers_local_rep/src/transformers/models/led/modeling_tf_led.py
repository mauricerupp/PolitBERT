...
LED_START_DOCSTRING = r"""
    ...
    Args:
        config (:class:`~transformers_local.LEDConfig`): Model configuration class with all the parameters of the model.
        ...
        **kwargs,
        ...
        Args:
            input_ids (:obj:`tf.Tensor` of shape :obj:`(batch_size, sequence_length)`):
                ...
                Indices can be obtained using :class:`~transformers_local.LEDTokenizer`. See
    ...
    def call(
        ...
        **kwargs,
        ...
        Args:
            input_ids (:obj:`tf.Tensor` of shape :obj:`(batch_size, sequence_length)`):
                Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you
                provide it. Indices can be obtained using :class:`~transformers_local.LEDTokenizer`. See
                :meth:`transformers_local.PreTrainedTokenizer.encode` and :meth:`transformers_local.PreTrainedTokenizer.__call__`
