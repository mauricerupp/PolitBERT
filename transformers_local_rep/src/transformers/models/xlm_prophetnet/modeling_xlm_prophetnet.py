...
class XLMProphetNetEncoder(ProphetNetEncoder):
    r"""
    This class overrides :class:`~transformers_local.ProphetNetEncoder`. Please check the superclass for the appropriate
...
class XLMProphetNetDecoder(ProphetNetDecoder):
    r"""
    This class overrides :class:`~transformers_local.ProphetNetDecoder`. Please check the superclass for the appropriate
    documentation alongside usage examples.
...
class XLMProphetNetModel(ProphetNetModel):
    r"""
    This class overrides :class:`~transformers_local.ProphetNetModel`. Please check the superclass for the appropriate
    documentation alongside usage examples.
...
class XLMProphetNetForConditionalGeneration(ProphetNetForConditionalGeneration):
    r"""
    This class overrides :class:`~transformers_local.ProphetNetForConditionalGeneration`. Please check the superclass for the
...
class XLMProphetNetForCausalLM(ProphetNetForCausalLM):
    r"""
    This class overrides :class:`~transformers_local.ProphetNetForCausalLM`. Please check the superclass for the appropriate
    documentation alongside usage examples.
