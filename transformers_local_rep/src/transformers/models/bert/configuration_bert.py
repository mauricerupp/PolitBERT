...
class BertConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformers_local.BertModel` or a
    :class:`~transformers_local.TFBertModel`. It is used to instantiate a BERT model according to the specified arguments,
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 30522):
            ...
            :obj:`inputs_ids` passed when calling :class:`~transformers_local.BertModel` or
            :class:`~transformers_local.TFBertModel`.
        ...
        type_vocab_size (:obj:`int`, `optional`, defaults to 2):
            The vocabulary size of the :obj:`token_type_ids` passed when calling :class:`~transformers_local.BertModel` or
            :class:`~transformers_local.TFBertModel`.
