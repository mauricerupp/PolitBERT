...
class TFAlbertForPreTrainingOutput(ModelOutput):
    """
    Output type of :class:`~transformers_local.TFAlbertForPreTraining`.
...
ALBERT_START_DOCSTRING = r"""
    ...
    Args:
        config (:class:`~transformers_local.AlbertConfig`): Model configuration class with all the parameters of the model.
...
ALBERT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`Numpy array` or :obj:`tf.Tensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~transformers_local.AlbertTokenizer`. See
