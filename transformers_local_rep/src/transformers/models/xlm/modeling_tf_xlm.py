...
class TFXLMWithLMHeadModelOutput(ModelOutput):
    """
    Base class for :class:`~transformers_local.TFXLMWithLMHeadModel` outputs.
...
XLM_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformers_local.XLMConfig`): Model configuration class with all the parameters of the model.
