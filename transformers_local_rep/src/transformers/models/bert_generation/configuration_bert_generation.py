...
class BertGenerationConfig(PretrainedConfig):
    ...
    :class:`~transformers_local.BertGenerationPreTrainedModel`. It is used to instantiate a BertGeneration model according to
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 50358):
            ...
            :obj:`inputs_ids` passed when calling :class:`~transformers_local.BertGeneration`.
