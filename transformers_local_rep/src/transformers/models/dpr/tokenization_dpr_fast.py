...
class DPRContextEncoderTokenizerFast(BertTokenizerFast):
    ...
    :class:`~transformers_local.DPRContextEncoderTokenizerFast` is identical to :class:`~transformers_local.BertTokenizerFast` and
    runs end-to-end tokenization: punctuation splitting and wordpiece.

    Refer to superclass :class:`~transformers_local.BertTokenizerFast` for usage examples and documentation concerning
    parameters.
    """
...
class DPRQuestionEncoderTokenizerFast(BertTokenizerFast):
    ...
    :class:`~transformers_local.DPRQuestionEncoderTokenizerFast` is identical to :class:`~transformers_local.BertTokenizerFast` and
    runs end-to-end tokenization: punctuation splitting and wordpiece.
...
class DPRReaderTokenizerFast(CustomDPRReaderTokenizerMixin, BertTokenizerFast):
    ...
    :class:`~transformers_local.DPRReaderTokenizerFast` is almost identical to :class:`~transformers_local.BertTokenizerFast` and
    runs end-to-end tokenization: punctuation splitting and wordpiece. The difference is that is has three inputs
    strings: question, titles and texts that are combined to be fed to the :class:`~transformers_local.DPRReader` model.
