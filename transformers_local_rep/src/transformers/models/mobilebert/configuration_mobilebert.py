...
class MobileBertConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformers_local.MobileBertModel` or a
    :class:`~transformers_local.TFMobileBertModel`. It is used to instantiate a MobileBERT model according to the specified
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 30522):
            ...
            the :obj:`inputs_ids` passed when calling :class:`~transformers_local.MobileBertModel` or
            :class:`~transformers_local.TFMobileBertModel`.
        ...
        type_vocab_size (:obj:`int`, `optional`, defaults to 2):
            The vocabulary size of the :obj:`token_type_ids` passed when calling :class:`~transformers_local.MobileBertModel`
            or :class:`~transformers_local.TFMobileBertModel`.
