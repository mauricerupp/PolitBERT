...
class BarthezTokenizerFast(PreTrainedTokenizerFast):
    """
    Adapted from :class:`~transformers_local.CamembertTokenizer` and :class:`~transformers_local.BartTokenizer`. Construct a "fast"
    BARThez tokenizer. Based on `SentencePiece <https://github.com/google/sentencepiece>`__.

    This tokenizer inherits from :class:`~transformers_local.PreTrainedTokenizerFast` which contains most of the main
