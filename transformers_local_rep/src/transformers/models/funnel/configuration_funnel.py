...
class FunnelConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformers_local.FunnelModel` or a
    :class:`~transformers_local.TFBertModel`. It is used to instantiate a Funnel Transformer model according to the specified
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 30522):
            ...
            by the :obj:`inputs_ids` passed when calling :class:`~transformers_local.FunnelModel` or
            :class:`~transformers_local.TFFunnelModel`.
        ...
        type_vocab_size (:obj:`int`, `optional`, defaults to 3):
            The vocabulary size of the :obj:`token_type_ids` passed when calling :class:`~transformers_local.FunnelModel` or
            :class:`~transformers_local.TFFunnelModel`.
