...
class TFLxmertForPreTrainingOutput(ModelOutput):
    """
    Output type of :class:`~transformers_local.LxmertForPreTraining`.
...
LXMERT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformers_local.LxmertConfig`): Model configuration class with all the parameters of the model.
...
LXMERT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`np.ndarray` or :obj:`tf.Tensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~transformers_local.LxmertTokenizer`. See
