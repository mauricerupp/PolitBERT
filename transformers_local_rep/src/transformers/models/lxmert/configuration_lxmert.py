...
class LxmertConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformers_local.LxmertModel` or a
    :class:`~transformers_local.TFLxmertModel`. It is used to instantiate a LXMERT model according to the specified
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 30522):
            ...
            :obj:`inputs_ids` passed when calling :class:`~transformers_local.LxmertModel` or
            :class:`~transformers_local.TFLxmertModel`.
