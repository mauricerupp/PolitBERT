...
class CTRLConfig(PretrainedConfig):
    """
    This is the configuration class to store the configuration of a :class:`~transformers_local.CTRLModel` or a
    :class:`~transformers_local.TFCTRLModel`. It is used to instantiate a CTRL model according to the specified arguments,
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 246534):
            ...
            :obj:`inputs_ids` passed when calling :class:`~transformers_local.CTRLModel` or
            :class:`~transformers_local.TFCTRLModel`.
