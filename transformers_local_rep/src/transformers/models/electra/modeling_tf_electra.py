...
class TFElectraForPreTrainingOutput(ModelOutput):
    """
    Output type of :class:`~transformers_local.TFElectraForPreTraining`.
...
ELECTRA_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformers_local.ElectraConfig`): Model configuration class with all the parameters of the model.
...
ELECTRA_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`Numpy array` or :obj:`tf.Tensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~transformers_local.ElectraTokenizer`. See
