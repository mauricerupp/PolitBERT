...
class ElectraConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformers_local.ElectraModel` or a
    :class:`~transformers_local.TFElectraModel`. It is used to instantiate a ELECTRA model according to the specified
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 30522):
            ...
            :obj:`inputs_ids` passed when calling :class:`~transformers_local.ElectraModel` or
            :class:`~transformers_local.TFElectraModel`.
        ...
        type_vocab_size (:obj:`int`, `optional`, defaults to 2):
            The vocabulary size of the :obj:`token_type_ids` passed when calling :class:`~transformers_local.ElectraModel` or
            :class:`~transformers_local.TFElectraModel`.
