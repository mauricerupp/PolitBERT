...
class TapasTruncationStrategy(ExplicitEnum):
    """
    Possible values for the ``truncation`` argument in :meth:`~transformers_local.TapasTokenizer.__call__`. Useful for
...
TAPAS_ENCODE_PLUS_ADDITIONAL_KWARGS_DOCSTRING = r"""
            ...
            padding (:obj:`bool`, :obj:`str` or :class:`~transformers_local.tokenization_utils_base.PaddingStrategy`, `optional`, defaults to :obj:`False`):
                ...
                * :obj:`False` or :obj:`'do_not_pad'` (default): No padding (i.e., can output a batch with sequences of
                  different lengths).
            truncation (:obj:`bool`, :obj:`str` or :class:`~transformers_local.TapasTruncationStrategy`, `optional`, defaults to :obj:`False`):
...
class TapasTokenizer(PreTrainedTokenizer):
    ...
    This tokenizer inherits from :class:`~transformers_local.PreTrainedTokenizer` which contains most of the main methods.
    Users should refer to this superclass for more information regarding those methods.
    :class:`~transformers_local.TapasTokenizer` creates several token type ids to encode tabular structure. To be more
    ...
    :class:`~transformers_local.TapasTokenizer` runs end-to-end tokenization on a table and associated sentences: punctuation
    ...
    def _get_truncated_table_rows(
        ...
        Args:
            ...
            truncation_strategy (:obj:`str` or :obj:`~transformers_local.TapasTruncationStrategy`):
    ...
    def convert_logits_to_predictions(self, data, logits, logits_agg=None, cell_classification_threshold=0.5):
        """
        Converts logits of :class:`~transformers_local.TapasForQuestionAnswering` to actual predicted answer coordinates and
        ...
        Args:
            data (:obj:`dict`):
                ...
                :class:`~transformers_local.TapasTokenizer`.
