...
class TapasConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformers_local.TapasModel`. It is used to
    ...
    architecture. Configuration objects inherit from :class:`~transformers_local.PreTrainedConfig` and can be used to control
    the model outputs. Read the documentation from :class:`~transformers_local.PretrainedConfig` for more information.
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 30522):
            ...
            :obj:`inputs_ids` passed when calling :class:`~transformers_local.TapasModel`.
        ...
        type_vocab_sizes (:obj:`List[int]`, `optional`, defaults to :obj:`[3, 256, 256, 2, 256, 256, 10]`):
            The vocabulary sizes of the :obj:`token_type_ids` passed when calling :class:`~transformers_local.TapasModel`.
