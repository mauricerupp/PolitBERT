...
class BartTokenizer(RobertaTokenizer):
    ...
    :class:`~transformers_local.BartTokenizer` is identical to :class:`~transformers_local.RobertaTokenizer`. Refer to superclass
    :class:`~transformers_local.RobertaTokenizer` for usage examples and documentation concerning the initialization
