...
BART_START_DOCSTRING = r"""
    ...
    Args:
        config (:class:`~transformers_local.BartConfig`): Model configuration class with all the parameters of the model.
...
BART_GENERATION_EXAMPLE = r"""
    Summarization example::
        ...
        >>> from transformers_local import BartTokenizer, TFBartForConditionalGeneration, BartConfig
...
BART_INPUTS_DOCSTRING = r"""
    Args:
        ...
        decoder_input_ids (:obj:`tf.Tensor` of shape :obj:`(batch_size, target_sequence_length)`, `optional`):
            ...
            Indices can be obtained using :class:`~transformers_local.BartTokenizer`. See
            :meth:`transformers_local.PreTrainedTokenizer.encode` and :meth:`transformers_local.PreTrainedTokenizer.__call__` for
            details.
