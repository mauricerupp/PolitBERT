...
class BartTokenizerFast(RobertaTokenizerFast):
    ...
    :class:`~transformers_local.BartTokenizerFast` is identical to :class:`~transformers_local.RobertaTokenizerFast`. Refer to
    superclass :class:`~transformers_local.RobertaTokenizerFast` for usage examples and documentation concerning the
