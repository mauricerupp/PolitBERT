...
RAG_CONFIG_DOC = r"""
    :class:`~transformers_local.RagConfig` stores the configuration of a `RagModel`. Configuration objects inherit from
    :class:`~transformers_local.PretrainedConfig` and can be used to control the model outputs. Read the documentation from
    :class:`~transformers_local.PretrainedConfig` for more information.
    ...
    Args:
        title_sep (:obj:`str`, `optional`, defaults to  ``" / "``):
            ...
            :class:`~transformers_local.RagRetriever`.
        ...
        max_combined_length (:obj:`int`, `optional`, defaults to 300):
            Max length of contextualized input returned by :meth:`~transformers_local.RagRetriever.__call__`.
        retrieval_vector_size (:obj:`int`, `optional`, defaults to 768):
            Dimensionality of the document embeddings indexed by :class:`~transformers_local.RagRetriever`.
        ...
        passages_path: (:obj:`str`, `optional`):
            ...
            :class:`~transformers_local.models.rag.retrieval_rag.LegacyIndex`
...
class RagConfig(PretrainedConfig):
    ...
    def from_question_encoder_generator_configs(
        ...
        r"""
        Instantiate a :class:`~transformers_local.EncoderDecoderConfig` (or a derived class) from a pre-trained encoder model
    ...
    def to_dict(self):
        ...
        :meth:`~transformers_local.PretrainedConfig.to_dict`.
