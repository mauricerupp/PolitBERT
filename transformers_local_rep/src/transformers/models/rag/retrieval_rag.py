...
class Index:
    """
    A base class for the Indices encapsulated by the :class:`~transformers_local.RagRetriever`.
    """
...
class RagRetriever:
    ...
    Args:
        ...
        index (:class:`~transformers_local.models.rag.retrieval_rag.Index`, optional, defaults to the one defined by the configuration):
    ...
    def __call__(
        ...
        Args:
            ...
            n_docs (:obj:`int`, `optional`):
                The number of docs retrieved per query.
            return_tensors (:obj:`str` or :class:`~transformers_local.tokenization_utils_base.TensorType`, `optional`, defaults to "pt"):
        ...
        Returns: :class:`~transformers_local.BatchEncoding`: A :class:`~transformers_local.BatchEncoding` with the following
        fields:
