...
class OpenAIGPTConfig(PretrainedConfig):
    """
    This is the configuration class to store the configuration of a :class:`~transformers_local.OpenAIGPTModel` or a
    :class:`~transformers_local.TFOpenAIGPTModel`. It is used to instantiate a GPT model according to the specified
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 40478):
            ...
            :obj:`inputs_ids` passed when calling :class:`~transformers_local.OpenAIGPTModel` or
            :class:`~transformers_local.TFOpenAIGPTModel`.
        ...
        summary_type (:obj:`str`, `optional`, defaults to :obj:`"cls_index"`):
            ...
            :class:`~transformers_local.OpenAIGPTDoubleHeadsModel` and :class:`~transformers_local.OpenAIGPTDoubleHeadsModel`.
