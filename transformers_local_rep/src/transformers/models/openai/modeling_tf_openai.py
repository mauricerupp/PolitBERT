...
OPENAI_GPT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformers_local.OpenAIGPTConfig`): Model configuration class with all the parameters of the model.
...
OPENAI_GPT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`Numpy array` or :obj:`tf.Tensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~transformers_local.OpenAIGPTTokenizer`. See
...
@add_start_docstrings(
    ...
    :class:`~transformers_local.TFOpenAIGPTForSequenceClassification` uses the last token in order to do the classification,
