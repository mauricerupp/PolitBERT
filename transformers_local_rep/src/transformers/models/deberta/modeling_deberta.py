...
class XSoftmax(torch.autograd.Function):
    ...
    Example::
      import torch
      from transformers_local.models.deberta import XSoftmax
      # Make a tensor
...
class DisentangledSelfAttention(torch.nn.Module):
    ...
    Parameters:
        config (:obj:`str`):
            ...
            `BertConfig`, for more details, please refer :class:`~transformers_local.DebertaConfig`
...
DEBERTA_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformers_local.DebertaConfig`): Model configuration class with all the parameters of the model.
...
DEBERTA_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`{0}`):
            ...
            Indices can be obtained using :class:`transformers_local.DebertaTokenizer`. See
