...
class BlenderbotSmallConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformers_local.BlenderbotSmallModel`. It is
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 50265):
            ...
            represented by the :obj:`inputs_ids` passed when calling :class:`~transformers_local.BlenderbotSmallModel` or
            :class:`~transformers_local.TFBlenderbotSmallModel`.
