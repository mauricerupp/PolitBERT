...
class XLNetConfig(PretrainedConfig):
    """
    This is the configuration class to store the configuration of a :class:`~transformers_local.XLNetModel` or a
    :class:`~transformers_local.TFXLNetModel`. It is used to instantiate a XLNet model according to the specified arguments,
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 32000):
            ...
            :obj:`inputs_ids` passed when calling :class:`~transformers_local.XLNetModel` or
            :class:`~transformers_local.TFXLNetModel`.
