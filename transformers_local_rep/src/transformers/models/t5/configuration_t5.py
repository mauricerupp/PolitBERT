...
class T5Config(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformers_local.T5Model` or a
    :class:`~transformers_local.TFT5Model`. It is used to instantiate a T5 model according to the specified arguments,
