...
class MT5Config(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformers_local.MT5Model` or a
    :class:`~transformers_local.TFMT5Model`. It is used to instantiate a mT5 model according to the specified arguments,
    ...
    Arguments:
        vocab_size (:obj:`int`, `optional`, defaults to 32128):
            ...
            :obj:`inputs_ids` passed when calling :class:`~transformers_local.T5Model` or :class:`~transformers_local.TFT5Model`.
