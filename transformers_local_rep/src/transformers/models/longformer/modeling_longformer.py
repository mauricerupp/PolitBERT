...
LONGFORMER_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformers_local.LongformerConfig`): Model configuration class with all the parameters of the
...
class LongformerModel(LongformerPreTrainedModel):
    """
    This class copied code from :class:`~transformers_local.RobertaModel` and overwrote standard self-attention with
