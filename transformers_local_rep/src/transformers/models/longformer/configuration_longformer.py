...
class LongformerConfig(RobertaConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformers_local.LongformerModel` or a
    :class:`~transformers_local.TFLongformerModel`. It is used to instantiate a Longformer model according to the specified
    arguments, defining the model architecture.

    This is the configuration class to store the configuration of a :class:`~transformers_local.LongformerModel`. It is used
    ...
    The :class:`~transformers_local.LongformerConfig` class directly inherits :class:`~transformers_local.RobertaConfig`. It reuses
