...
LONGFORMER_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformers_local.LongformerConfig`): Model configuration class with all the parameters of the model.
...
LONGFORMER_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`tf.Tensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~transformers_local.LongformerTokenizer`. See
...
class TFLongformerModel(TFLongformerPreTrainedModel):
    ...
    This class copies code from :class:`~transformers_local.TFRobertaModel` and overwrites standard self-attention with
