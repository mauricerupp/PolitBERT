...
class FlaubertConfig(XLMConfig):
    """
    This is the configuration class to store the configuration of a :class:`~transformers_local.FlaubertModel` or a
    :class:`~transformers_local.TFFlaubertModel`. It is used to instantiate a FlauBERT model according to the specified
    ...
    Args:
        ...
        vocab_size (:obj:`int`, `optional`, defaults to 30145):
            ...
            the :obj:`inputs_ids` passed when calling :class:`~transformers_local.FlaubertModel` or
            :class:`~transformers_local.TFFlaubertModel`.
