...
class TrainingArguments:
    ...
    Using :class:`~transformers_local.HfArgumentParser` we can turn this class into `argparse
    ...
    Parameters:
        ...
        do_train (:obj:`bool`, `optional`, defaults to :obj:`False`):
            Whether to run training or not. This argument is not directly used by :class:`~transformers_local.Trainer`, it's
        ...
        do_eval (:obj:`bool`, `optional`):
            ...
            :class:`~transformers_local.Trainer`, it's intended to be used by your training/evaluation scripts instead. See
        ...
        do_predict (:obj:`bool`, `optional`, defaults to :obj:`False`):
            ...
            the `example scripts <https://github.com/huggingface/transformers/tree/master/examples>`__ for more
            details.
        evaluation_strategy (:obj:`str` or :class:`~transformers_local.trainer_utils.EvaluationStrategy`, `optional`, defaults to :obj:`"no"`):
        ...
        learning_rate (:obj:`float`, `optional`, defaults to 5e-5):
            The initial learning rate for :class:`~transformers_local.AdamW` optimizer.
        weight_decay (:obj:`float`, `optional`, defaults to 0):
            The weight decay to apply (if not zero) to all layers except all bias and LayerNorm weights in
            :class:`~transformers_local.AdamW` optimizer.
        adam_beta1 (:obj:`float`, `optional`, defaults to 0.9):
            The beta1 hyperparameter for the :class:`~transformers_local.AdamW` optimizer.
        adam_beta2 (:obj:`float`, `optional`, defaults to 0.999):
            The beta2 hyperparameter for the :class:`~transformers_local.AdamW` optimizer.
        adam_epsilon (:obj:`float`, `optional`, defaults to 1e-8):
            The epsilon hyperparameter for the :class:`~transformers_local.AdamW` optimizer.
        ...
        lr_scheduler_type (:obj:`str` or :class:`~transformers_local.SchedulerType`, `optional`, defaults to :obj:`"linear"`):
            The scheduler type to use. See the documentation of :class:`~transformers_local.SchedulerType` for all possible
            values.
        ...
        seed (:obj:`int`, `optional`, defaults to 42):
            ...
            :func:`~transformers_local.Trainer.model_init` function to instantiate the model if it has some randomly
        ...
        disable_tqdm (:obj:`bool`, `optional`):
            ...
            :class:`~transformers_local.notebook.NotebookTrainingTracker` in Jupyter Notebooks. Will default to :obj:`True`
        ...
        remove_unused_columns (:obj:`bool`, `optional`, defaults to :obj:`True`):
            ...
            (Note that this behavior is not implemented for :class:`~transformers_local.TFTrainer` yet.)
        ...
        adafactor (:obj:`bool`, `optional`, defaults to :obj:`False`):
            Whether or not to use the :class:`~transformers_local.Adafactor` optimizer instead of
            :class:`~transformers_local.AdamW`.
