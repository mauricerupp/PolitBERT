...
class TFTrainer:
    ...
    Args:
        ...
        optimizers (:obj:`Tuple[tf.keras.optimizers.Optimizer, tf.keras.optimizers.schedules.LearningRateSchedule]`, `optional`):
            ...
            :class:`~transformers_local.AdamWeightDecay`. The scheduler will default to an instance of
            :class:`tf.keras.optimizers.schedules.PolynomialDecay` if :obj:`args.num_warmup_steps` is 0 else an
            instance of :class:`~transformers_local.WarmUp`.
    """
    ...
    def prediction_loop(
        ...
        """
        Prediction/evaluation loop, shared by :func:`~transformers_local.TFTrainer.evaluate` and
        :func:`~transformers_local.TFTrainer.predict`.
