...
path = /path/to/transformers_local/.env/bin/python

args = -m debugpy --listen 5678 --wait-for-client /path/to/transformers_local/src/transformers_local/commands/transformers_cli.py
