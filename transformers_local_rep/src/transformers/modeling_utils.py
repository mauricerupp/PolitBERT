...
class ModuleUtilsMixin:
    ...
    def reset_memory_hooks_state(self):
        ...
        :func:`~transformers_local.modeling_utils.ModuleUtilsMixin.add_memory_hooks`).
        """
        for module in self.modules():
    ...
    def floating_point_ops(
        ...
        <https://arxiv.org/pdf/2001.08361.pdf>`__ section 2.1. Should be overridden for transformers_local with parameter
...
class PreTrainedModel(nn.Module, ModuleUtilsMixin, GenerationMixin):
    ...
    :class:`~transformers_local.PreTrainedModel` takes care of storing the configuration of the models and handles methods
    ...
    Class attributes (overridden by derived classes):
        ...
        - **config_class** (:class:`~transformers_local.PretrainedConfig`) -- A subclass of
          :class:`~transformers_local.PretrainedConfig` to use as configuration class for this model architecture.
        - **load_tf_weights** (:obj:`Callable`) -- A python `method` for loading a TensorFlow checkpoint in a PyTorch
          model, taking as arguments:

            - **model** (:class:`~transformers_local.PreTrainedModel`) -- An instance of the model on which to load the
              TensorFlow checkpoint.
            - **config** (:class:`~transformers_local.PreTrainedConfig`) -- An instance of the configuration associated to
              the model.
    ...
    def save_pretrained(self, save_directory: Union[str, os.PathLike]):
        ...
        `:func:`~transformers_local.PreTrainedModel.from_pretrained`` class method.
        ...
        Parameters:
            ...
            config (:obj:`Union[PretrainedConfig, str, os.PathLike]`, `optional`):
                Can be either:
                    ...
                    - an instance of a class derived from :class:`~transformers_local.PretrainedConfig`,
                    - a string or path valid as input to :func:`~transformers_local.PretrainedConfig.from_pretrained`.
                ...
                be automatically loaded when:
                    ...
                    - The model is a model provided by the library (loaded with the `model id` string of a pretrained
                      model).
                    - The model was saved using :func:`~transformers_local.PreTrainedModel.save_pretrained` and is reloaded
...
class SquadHeadOutput(ModelOutput):
    """
    Base class for outputs of question answering models using a :class:`~transformers_local.modeling_utils.SQuADHead`.
...
def prune_layer(
    ...
    Returns:
        :obj:`torch.nn.Linear` or :class:`~transformers_local.modeling_utils.Conv1D`: The pruned layer as a new layer with
