...
class BatchEncoding(UserDict):
    """
    Holds the output of the :meth:`~transformers_local.tokenization_utils_base.PreTrainedTokenizerBase.encode_plus` and
    :meth:`~transformers_local.tokenization_utils_base.PreTrainedTokenizerBase.batch_encode` methods (tokens,
    attention_masks, etc).
    ...
    def n_sequences(self) -> Optional[int]:
        ...
        :class:`~transformers_local.BatchEncoding`. Currently can be one of :obj:`None` (unknown), :obj:`1` (a single
    ...
    def is_fast(self) -> bool:
        """
        :obj:`bool`: Indicate whether this :class:`~transformers_local.BatchEncoding` was generated from the result of a
        :class:`~transformers_local.PreTrainedTokenizerFast` or not.
        """
    ...
    def word_to_tokens(
        ...
        Token spans are returned as a :class:`~transformers_local.tokenization_utils_base.TokenSpan` with:
        ...
        Returns:
            Optional :class:`~transformers_local.tokenization_utils_base.TokenSpan` Span of tokens in the encoded sequence.
    ...
    def token_to_chars(self, batch_or_token_index: int, token_index: Optional[int] = None) -> CharSpan:
        ...
        Character spans are returned as a :class:`~transformers_local.tokenization_utils_base.CharSpan` with:
    ...
    def convert_to_tensors(
        ...
        Args:
            tensor_type (:obj:`str` or :class:`~transformers_local.tokenization_utils_base.TensorType`, `optional`):
                The type of tensors to use. If :obj:`str`, should be one of the values of the enum
                :class:`~transformers_local.tokenization_utils_base.TensorType`. If :obj:`None`, no modification is done.
    ...
    def to(self, device: Union[str, "torch.device"]) -> "BatchEncoding":
        ...
        Returns:
            :class:`~transformers.BatchEncoding`: The same instance of :class:`~transformers_local.BatchEncoding` after
            modification.
        """
...
class SpecialTokensMixin:
    """
    A mixin derived by :class:`~transformers_local.PreTrainedTokenizer` and :class:`~transformers_local.PreTrainedTokenizerFast` to
    ...
    def add_special_tokens(self, special_tokens_dict: Dict[str, Union[str, AddedToken]]) -> int:
        ...
        :class:`~transformers_local.BertTokenizer` :obj:`cls_token` is already registered to be :obj`'[CLS]'` and XLM's one
...
ENCODE_PLUS_ADDITIONAL_KWARGS_DOCSTRING = r"""
            ...
            return_offsets_mapping (:obj:`bool`, `optional`, defaults to :obj:`False`):
                ...
                :class:`~transformers_local.PreTrainedTokenizerFast`, if using Python's tokenizer, this method will raise
        ...
        Return:
            :class:`~transformers_local.BatchEncoding`: A :class:`~transformers_local.BatchEncoding` with the following fields:
...
INIT_TOKENIZER_DOCSTRING = r"""
    Class attributes (overridden by derived classes)
        ...
        - **pretrained_init_configuration** (:obj:`Dict[str, Dict[str, Any]]`) -- A dictionary with, as keys, the
          ...
          tokenizer with the :meth:`~transformers_local.tokenization_utils_base.PreTrainedTokenizerBase.from_pretrained`
          method.
    ...
    Args:
        model_max_length (:obj:`int`, `optional`):
            ...
            loaded with :meth:`~transformers_local.tokenization_utils_base.PreTrainedTokenizerBase.from_pretrained`, this
...
class PreTrainedTokenizerBase(SpecialTokensMixin):
    """
    Base class for :class:`~transformers_local.PreTrainedTokenizer` and :class:`~transformers_local.PreTrainedTokenizerFast`.
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Union[str, os.PathLike], *init_inputs, **kwargs):
        r"""
        Instantiate a :class:`~transformers_local.tokenization_utils_base.PreTrainedTokenizerBase` (or a derived class) from
        ...
        Args:
            pretrained_model_name_or_path (:obj:`str` or :obj:`os.PathLike`):
                ...
                - A path to a `directory` containing vocabulary files required by the tokenizer, for instance saved
                  using the :meth:`~transformers_local.tokenization_utils_base.PreTrainedTokenizerBase.save_pretrained`
            ...
            use_auth_token (:obj:`str` or `bool`, `optional`):
                ...
                generated when running :obj:`transformers_local-cli login` (stored in :obj:`~/.huggingface`).
    ...
    def save_pretrained(
        ...
        :meth:`~transformers_local.tokenization_utils_base.PreTrainedTokenizer.from_pretrained` class method.

        .. Note::
            A "fast" tokenizer (instance of :class:`transformers_local.PreTrainedTokenizerFast`) saved with this method will
            not be possible to load back in a "slow" tokenizer, i.e. in a :class:`transformers_local.PreTrainedTokenizer`
            instance. It can only be loaded in a "fast" tokenizer, i.e. in a
            :class:`transformers_local.PreTrainedTokenizerFast` instance.
    ...
    def _save_pretrained(
        ...
        specific :meth:`~transformers_local.tokenization_utils_fast.PreTrainedTokenizerFast._save_pretrained`
        """
    ...
    def save_vocabulary(self, save_directory: str, filename_prefix: Optional[str] = None) -> Tuple[str]:
        ...
        :meth:`~transformers_local.PreTrainedTokenizerFast._save_pretrained` to save the whole state of the tokenizer.
    ...
    def tokenize(self, text: str, pair: Optional[str] = None, add_special_tokens: bool = False, **kwargs) -> List[str]:
        ...
        Args:
            ...
            kwargs (additional keyword arguments, `optional`):
                ...
                :meth:`~transformers_local.PreTrainedTokenizerBase.__call__`
    ...
    def pad(
        ...
        Args:
            encoded_inputs (:class:`~transformers_local.BatchEncoding`, list of :class:`~transformers_local.BatchEncoding`, :obj:`Dict[str, List[int]]`, :obj:`Dict[str, List[List[int]]` or :obj:`List[Dict[str, List[int]]]`):
                Tokenized inputs. Can represent one input (:class:`~transformers_local.BatchEncoding` or :obj:`Dict[str,
                List[int]]`) or a batch of tokenized inputs (list of :class:`~transformers_local.BatchEncoding`, `Dict[str,
                List[List[int]]]` or `List[Dict[str, List[int]]]`) so you can use this method during preprocessing as
                well as in a PyTorch Dataloader collate function.

                Instead of :obj:`List[int]` you can have tensors (numpy arrays, PyTorch tensors or TensorFlow tensors),
                see the note above for the return type.
            padding (:obj:`bool`, :obj:`str` or :class:`~transformers_local.tokenization_utils_base.PaddingStrategy`, `optional`, defaults to :obj:`True`):
    ...
    def truncate_sequences(
        ...
        Args:
            ...
            truncation_strategy (:obj:`str` or :class:`~transformers_local.tokenization_utils_base.TruncationStrategy`, `optional`, defaults to :obj:`False`):
        ...
        **kwargs,
        ...
        Arguments:
            ...
            return_tensors (:obj:`str` or :class:`~transformers_local.tokenization_utils_base.TensorType`, `optional`):
                ...
                * :obj:`'pt'`: Return PyTorch :obj:`torch.Tensor` objects.
                * :obj:`'np'`: Return Numpy :obj:`np.ndarray` objects.
            truncation (:obj:`bool`, :obj:`str` or :class:`~transformers_local.tokenization_utils_base.TruncationStrategy`, `optional`, defaults to :obj:`True`):
                Activates and controls truncation. Accepts the following values:
        ...
        Return:
            :class:`~transformers.BatchEncoding`: A :class:`~transformers_local.BatchEncoding` with the following fields:
