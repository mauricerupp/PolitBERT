...
def get_framework(model, revision: Optional[str] = None):
    ...
    Args:
        model (:obj:`str`, :class:`~transformers_local.PreTrainedModel` or :class:`~transformers_local.TFPreTrainedModel`):
...
class PipelineException(Exception):
    """
    Raised by a :class:`~transformers_local.Pipeline` when handling __call__.
...
class ArgumentHandler(ABC):
    """
    Base interface for handling arguments for each :class:`~transformers_local.pipelines.Pipeline`.
    """
...
class PipelineDataFormat:
    ...
    def save(self, data: Union[dict, List[dict]]):
        ...
        :class:`~transformers_local.pipelines.PipelineDataFormat`.
    ...
    def from_str(
        ...
        """
        Creates an instance of the right subclass of :class:`~transformers_local.pipelines.PipelineDataFormat` depending on
        :obj:`format`.
...
PIPELINE_INIT_ARGS = r"""
    Arguments:
        model (:obj:`~transformers_local.PreTrainedModel` or :obj:`~transformers_local.TFPreTrainedModel`):
            The model that will be used by the pipeline to make predictions. This needs to be a model inheriting from
            :class:`~transformers_local.PreTrainedModel` for PyTorch and :class:`~transformers_local.TFPreTrainedModel` for
            TensorFlow.
        tokenizer (:obj:`~transformers_local.PreTrainedTokenizer`):
            The tokenizer that will be used by the pipeline to encode data for the model. This object inherits from
            :class:`~transformers_local.PreTrainedTokenizer`.
        modelcard (:obj:`str` or :class:`~transformers_local.ModelCard`, `optional`):
        ...
        args_parser (:class:`~transformers_local.pipelines.ArgumentHandler`, `optional`):
...
class Pipeline(_ScikitCompat):
    ...
    Some pipeline, like for instance :class:`~transformers_local.FeatureExtractionPipeline` (:obj:`'feature-extraction'` )
