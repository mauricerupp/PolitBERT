...
class ZeroShotClassificationPipeline(Pipeline):
    ...
    This NLI pipeline can currently be loaded from :func:`~transformers_local.pipeline` using the following task identifier:
    ...
    def __call__(
        ...
        """
        Classify the sequence(s) given as inputs. See the :obj:`~transformers_local.ZeroShotClassificationPipeline`
