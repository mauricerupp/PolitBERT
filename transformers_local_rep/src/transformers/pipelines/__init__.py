...
def pipeline(
    ...
    **kwargs
    ...
    """
    Utility factory method to build a :class:`~transformers_local.Pipeline`.
    ...
    Args:
        task (:obj:`str`):
            ...
            - :obj:`"feature-extraction"`: will return a :class:`~transformers_local.FeatureExtractionPipeline`.
            - :obj:`"sentiment-analysis"`: will return a :class:`~transformers_local.TextClassificationPipeline`.
            - :obj:`"ner"`: will return a :class:`~transformers_local.TokenClassificationPipeline`.
            - :obj:`"question-answering"`: will return a :class:`~transformers_local.QuestionAnsweringPipeline`.
            - :obj:`"fill-mask"`: will return a :class:`~transformers_local.FillMaskPipeline`.
            - :obj:`"summarization"`: will return a :class:`~transformers_local.SummarizationPipeline`.
            - :obj:`"translation_xx_to_yy"`: will return a :class:`~transformers_local.TranslationPipeline`.
            - :obj:`"text2text-generation"`: will return a :class:`~transformers_local.Text2TextGenerationPipeline`.
            - :obj:`"text-generation"`: will return a :class:`~transformers_local.TextGenerationPipeline`.
            - :obj:`"zero-shot-classification:`: will return a :class:`~transformers_local.ZeroShotClassificationPipeline`.
            - :obj:`"conversation"`: will return a :class:`~transformers_local.ConversationalPipeline`.
        model (:obj:`str` or :obj:`~transformers_local.PreTrainedModel` or :obj:`~transformers_local.TFPreTrainedModel`, `optional`):
            The model that will be used by the pipeline to make predictions. This can be a model identifier or an
            actual instance of a pretrained model inheriting from :class:`~transformers_local.PreTrainedModel` (for PyTorch)
            or :class:`~transformers_local.TFPreTrainedModel` (for TensorFlow).

            If not provided, the default for the :obj:`task` will be loaded.
        config (:obj:`str` or :obj:`~transformers_local.PretrainedConfig`, `optional`):
            The configuration that will be used by the pipeline to instantiate the model. This can be a model
            identifier or an actual pretrained model configuration inheriting from
            :class:`~transformers_local.PretrainedConfig`.
        ...
        tokenizer (:obj:`str` or :obj:`~transformers_local.PreTrainedTokenizer`, `optional`):
            The tokenizer that will be used by the pipeline to encode data for the model. This can be a model
            identifier or an actual pretrained tokenizer inheriting from :class:`~transformers_local.PreTrainedTokenizer`.
        ...
        use_fast (:obj:`bool`, `optional`, defaults to :obj:`True`):
            Whether or not to use a Fast tokenizer if possible (a :class:`~transformers_local.PreTrainedTokenizerFast`).
        kwargs:
