...
class Conversation:
    ...
    :class:`~transformers_local.ConversationalPipeline`. The conversation contains a number of utility function to manage the
    addition of new user input and generated model responses. A conversation needs to contain an unprocessed user input
    before being passed to the :class:`~transformers_local.ConversationalPipeline`. This user input is either created when
    ...
    Arguments:
        text (:obj:`str`, `optional`):
            ...
            manually using the :meth:`~transformers_local.Conversation.add_user_input` method before the conversation can
            begin.
...
class ConversationalPipeline(Pipeline):
    ...
    This conversational pipeline can currently be loaded from :func:`~transformers_local.pipeline` using the following task
    ...
    def __call__(
        ...
        **generate_kwargs
        ...
        Args:
            conversations (a :class:`~transformers_local.Conversation` or a list of :class:`~transformers_local.Conversation`):
        ...
        Returns:
            :class:`~transformers_local.Conversation` or a list of :class:`~transformers_local.Conversation`: Conversation(s) with
