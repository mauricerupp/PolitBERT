...
class QuestionAnsweringArgumentHandler(ArgumentHandler):
    ...
    internal :class:`~transformers_local.SquadExample`.

    QuestionAnsweringArgumentHandler manages all the possible to create a :class:`~transformers_local.SquadExample` from the
...
class QuestionAnsweringPipeline(Pipeline):
    ...
    This question answering pipeline can currently be loaded from :func:`~transformers_local.pipeline` using the following
    ...
    def create_sample(
        ...
        """
        QuestionAnsweringPipeline leverages the :class:`~transformers_local.SquadExample` internally. This helper method
        encapsulate all the logic for converting question(s) and context(s) to :class:`~transformers_local.SquadExample`.
        ...
        Returns:
            One or a list of :class:`~transformers_local.SquadExample`: The corresponding :class:`~transformers_local.SquadExample`
    ...
    def __call__(self, *args, **kwargs):
        ...
        Args:
            args (:class:`~transformers_local.SquadExample` or a list of :class:`~transformers_local.SquadExample`):
                One or several :class:`~transformers_local.SquadExample` containing the question and context.
            X (:class:`~transformers_local.SquadExample` or a list of :class:`~transformers_local.SquadExample`, `optional`):
                One or several :class:`~transformers_local.SquadExample` containing the question and context (will be treated
                the same way as if passed as the first positional argument).
            data (:class:`~transformers_local.SquadExample` or a list of :class:`~transformers_local.SquadExample`, `optional`):
                One or several :class:`~transformers_local.SquadExample` containing the question and context (will be treated
                the same way as if passed as the first positional argument).
