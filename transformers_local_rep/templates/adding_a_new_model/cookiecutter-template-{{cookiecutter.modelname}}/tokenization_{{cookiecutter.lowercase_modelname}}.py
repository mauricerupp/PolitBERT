...
class {{cookiecutter.camelcase_modelname}}Tokenizer(BertTokenizer):
    ...
    :class:`~transformers_local.{{cookiecutter.camelcase_modelname}}Tokenizer` is identical to :class:`~transformers_local.BertTokenizer` and runs end-to-end
...
class {{cookiecutter.camelcase_modelname}}Tokenizer(BartTokenizer):
    ...
    :class:`~transformers_local.{{cookiecutter.camelcase_modelname}}Tokenizer` is identical to :class:`~transformers_local.BartTokenizer` and runs end-to-end
    tokenization: punctuation splitting and wordpiece.

    Refer to superclass :class:`~transformers_local.BartTokenizer` for usage examples and documentation concerning
    parameters.
    """
