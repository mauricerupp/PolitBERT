...
class {{cookiecutter.camelcase_modelname}}Config(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformers_local.{{cookiecutter.camelcase_modelname}}Model`.
    ...
    Configuration objects inherit from  :class:`~transformers_local.PretrainedConfig` and can be used
    to control the model outputs. Read the documentation from  :class:`~transformers_local.PretrainedConfig`
    ...
    Args:
        ...
        vocab_size (:obj:`int`, `optional`, defaults to 30522):
            ...
            :obj:`inputs_ids` passed when calling :class:`~transformers_local.{{cookiecutter.camelcase_modelname}}Model` or
            :class:`~transformers_local.TF{{cookiecutter.camelcase_modelname}}Model`.
            Vocabulary size of the  model. Defines the different tokens that
            can be represented by the `inputs_ids` passed to the forward method of :class:`~transformers_local.{{cookiecutter.camelcase_modelname}}Model`.
        ...
        type_vocab_size (:obj:`int`, `optional`, defaults to 2):
            The vocabulary size of the :obj:`token_type_ids` passed when calling :class:`~transformers_local.{{cookiecutter.camelcase_modelname}}Model` or
            :class:`~transformers_local.TF{{cookiecutter.camelcase_modelname}}Model`.
    ...
    Example::
        ...
        >>> from transformers_local import {{cookiecutter.camelcase_modelname}}Model, {{cookiecutter.camelcase_modelname}}Config
