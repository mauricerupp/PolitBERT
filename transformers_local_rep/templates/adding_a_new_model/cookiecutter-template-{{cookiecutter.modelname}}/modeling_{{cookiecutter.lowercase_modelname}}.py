...
# Copied from transformers_local.models.bert.modeling_bert.BertEmbeddings with Bert->{{cookiecutter.camelcase_modelname}}
...
# Copied from transformers_local.models.bert.modeling_bert.BertSelfAttention with Bert->{{cookiecutter.camelcase_modelname}}
...
# Copied from transformers_local.models.bert.modeling_bert.BertSelfOutput with Bert->{{cookiecutter.camelcase_modelname}}
...
# Copied from transformers_local.models.bert.modeling_bert.BertAttention with Bert->{{cookiecutter.camelcase_modelname}}
...
# Copied from transformers_local.models.bert.modeling_bert.BertIntermediate with Bert->{{cookiecutter.camelcase_modelname}}
...
# Copied from transformers_local.models.bert.modeling_bert.BertOutput with Bert->{{cookiecutter.camelcase_modelname}}
...
# Copied from transformers_local.models.bert.modeling_bert.BertLayer with Bert->{{cookiecutter.camelcase_modelname}}
...
# Copied from transformers_local.models.bert.modeling_bert.BertEncoder with Bert->{{cookiecutter.camelcase_modelname}}
...
# Copied from transformers_local.models.bert.modeling_bert.BertPredictionHeadTransform with Bert->{{cookiecutter.camelcase_modelname}}
...
# Copied from transformers_local.models.bert.modeling_bert.BertLMPredictionHead with Bert->{{cookiecutter.camelcase_modelname}}
...
# Copied from transformers_local.models.bert.modeling_bert.BertOnlyMLMHead with Bert->{{cookiecutter.camelcase_modelname}}
...
{{cookiecutter.uppercase_modelname}}_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformers_local.{{cookiecutter.camelcase_modelname}}Config`): Model configuration class with all the parameters of the model.
            Initializing with a config file does not load the weights associated with the model, only the configuration.
            Check out the :meth:`~transformers_local.PreTrainedModel.from_pretrained` method to load the model weights.
"""
...
{{cookiecutter.uppercase_modelname}}_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`{0}`):
            ...
            Indices can be obtained using :class:`transformers_local.{{cookiecutter.camelcase_modelname}}Tokenizer`.
            See :func:`transformers_local.PreTrainedTokenizer.encode` and
            :func:`transformers_local.PreTrainedTokenizer.__call__` for details.
...
class {{cookiecutter.camelcase_modelname}}ForCausalLM({{cookiecutter.camelcase_modelname}}PreTrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> from transformers_local import {{cookiecutter.camelcase_modelname}}Tokenizer, {{cookiecutter.camelcase_modelname}}ForCausalLM, {{cookiecutter.camelcase_modelname}}Config
            >>> import torch
...
# Copied from transformers_local.models.bart.modeling_bart.BartClassificationHead with Bart->{{cookiecutter.camelcase_modelname}}
class {{cookiecutter.camelcase_modelname}}ClassificationHead(nn.Module):
    """Head for sentence-level classification tasks."""
...
{{cookiecutter.uppercase_modelname}}_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformers_local.{{cookiecutter.camelcase_modelname}}Config`):
...
{{cookiecutter.uppercase_modelname}}_GENERATION_EXAMPLE = r"""
    Summarization example::
        ...
        >>> from transformers_local import {{cookiecutter.camelcase_modelname}}Tokenizer, {{cookiecutter.camelcase_modelname}}ForConditionalGeneration, {{cookiecutter.camelcase_modelname}}Config
...
{{cookiecutter.uppercase_modelname}}_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~transformers_local.{{cookiecutter.camelcase_modelname}}Tokenizer`. See
            :meth:`transformers_local.PreTrainedTokenizer.encode` and :meth:`transformers_local.PreTrainedTokenizer.__call__` for
            details.
...
{{cookiecutter.uppercase_modelname}}_STANDALONE_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~transformers_local.ProphetNetTokenizer`. See
            :meth:`transformers_local.PreTrainedTokenizer.encode` and :meth:`transformers_local.PreTrainedTokenizer.__call__` for
            details.
    ...
    def forward(
        ...
        Args:
            input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
                ...
                Indices can be obtained using :class:`~transformers_local.{{cookiecutter.camelcase_modelname}}Tokenizer`. See
                :meth:`transformers_local.PreTrainedTokenizer.encode` and :meth:`transformers_local.PreTrainedTokenizer.__call__`
                for details.
...
class {{cookiecutter.camelcase_modelname}}ForConditionalGeneration({{cookiecutter.camelcase_modelname}}PreTrainedModel):
    ...
    def forward(
        ...
        Conditional generation example::
            ...
            >>> from transformers_local import {{cookiecutter.camelcase_modelname}}Tokenizer, {{cookiecutter.camelcase_modelname}}ForConditionalGeneration
            >>> tokenizer = {{cookiecutter.camelcase_modelname}}Tokenizer.from_pretrained('{{cookiecutter.checkpoint_identifier}}')
...
# Copied from transformers_local.models.bart.modeling_bart.BartDecoderWrapper with Bart->{{cookiecutter.camelcase_modelname}}
class {{cookiecutter.camelcase_modelname}}DecoderWrapper({{cookiecutter.camelcase_modelname}}PreTrainedModel):
    ...
    used in combination with the :class:`~transformers_local.EncoderDecoderModel` framework.
    """
...
# Copied from transformers_local.models.bart.modeling_bart.BartForCausalLM with Bart->{{cookiecutter.camelcase_modelname}}
class {{cookiecutter.camelcase_modelname}}ForCausalLM({{cookiecutter.camelcase_modelname}}PreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
    ...
    def forward(
        ...
        Example::
            ...
            >>> from transformers_local import {{cookiecutter.camelcase_modelname}}Tokenizer, {{cookiecutter.camelcase_modelname}}ForCausalLM
