...
# To replace in: "src/transformers_local/__init__.py"
...
# To replace in: "src/transformers_local/models/__init__.py"
# Below: "from . import ("
# Replace with:
...
# To replace in: "src/transformers_local/models/auto/configuration_auto.py"
...
# To replace in: "src/transformers_local/models/auto/modeling_auto.py" if generating PyTorch
...
# To replace in: "src/transformers_local/models/auto/modeling_tf_auto.py" if generating TensorFlow
# Below: "from .configuration_auto import ("
# Replace with:
    {{cookiecutter.camelcase_modelname}}Config,
# End.
