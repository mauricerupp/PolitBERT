...
class {{cookiecutter.camelcase_modelname}}TokenizerFast(BertTokenizerFast):
    ...
    :class:`~transformers_local.{{cookiecutter.camelcase_modelname}}TokenizerFast` is identical to :class:`~transformers_local.BertTokenizerFast` and runs
...
class {{cookiecutter.camelcase_modelname}}TokenizerFast(BartTokenizerFast):
    ...
    :class:`~transformers_local.{{cookiecutter.camelcase_modelname}}TokenizerFast` is identical to :class:`~transformers_local.BartTokenizerFast` and runs
    end-to-end tokenization: punctuation splitting and wordpiece.

    Refer to superclass :class:`~transformers_local.BartTokenizerFast` for usage examples and documentation concerning
    parameters.
    """
