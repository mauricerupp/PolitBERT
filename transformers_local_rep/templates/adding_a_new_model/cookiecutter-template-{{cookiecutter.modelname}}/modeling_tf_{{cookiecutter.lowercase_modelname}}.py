...
# Copied from transformers_local.models.bert.modeling_tf_bert.TFBertEmbeddings with Bert->{{cookiecutter.camelcase_modelname}}
...
# Copied from transformers_local.models.bert.modeling_tf_bert.TFBertSelfAttention with Bert->{{cookiecutter.camelcase_modelname}}
...
# Copied from transformers_local.models.bert.modeling_tf_bert.TFBertSelfOutput with Bert->{{cookiecutter.camelcase_modelname}}
...
# Copied from transformers_local.models.bert.modeling_tf_bert.TFBertAttention with Bert->{{cookiecutter.camelcase_modelname}}
...
# Copied from transformers_local.models.bert.modeling_tf_bert.TFBertIntermediate with Bert->{{cookiecutter.camelcase_modelname}}
...
# Copied from transformers_local.models.bert.modeling_tf_bert.TFBertOutput with Bert->{{cookiecutter.camelcase_modelname}}
...
# Copied from transformers_local.models.bert.modeling_tf_bert.TFBertEncoder with Bert->{{cookiecutter.camelcase_modelname}}
...
# Copied from transformers_local.models.bert.modeling_tf_bert.TFBertPredictionHeadTransform with Bert->{{cookiecutter.camelcase_modelname}}
...
# Copied from transformers_local.models.bert.modeling_tf_bert.TFBertLMPredictionHead with Bert->{{cookiecutter.camelcase_modelname}}
...
# Copied from transformers_local.models.bert.modeling_tf_bert.TFBertMLMHead with Bert->{{cookiecutter.camelcase_modelname}}
...
{{cookiecutter.uppercase_modelname}}_START_DOCSTRING = r"""
    ...
    This model inherits from :class:`~transformers_local.TFPreTrainedModel`. Check the superclass documentation for the
...
{{cookiecutter.uppercase_modelname}}_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`np.ndarray`, :obj:`tf.Tensor`, :obj:`List[tf.Tensor]` :obj:`Dict[str, tf.Tensor]` or :obj:`Dict[str, np.ndarray]` and each example must have the shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~transformers_local.BertTokenizer`. See
            :func:`transformers_local.PreTrainedTokenizer.__call__` and :func:`transformers_local.PreTrainedTokenizer.encode` for
            details.
        ...
        return_dict (:obj:`bool`, `optional`):
            Whether or not to return a :class:`~transformers_local.file_utils.ModelOutput` instead of a plain tuple. This
...
{{cookiecutter.uppercase_modelname}}_START_DOCSTRING = r"""
    ...
    Args:
        config (:class:`~transformers_local.{{cookiecutter.camelcase_modelname}}Config`): Model configuration class with all the parameters of the model.
            ...
            configuration. Check out the :meth:`~transformers_local.TFPreTrainedModel.from_pretrained` method to load the
            model weights.
"""
    ...
    def call(
        ...
        **kwargs,
        ...
        Examples::
            ...
            >>> from transformers_local import {{cookiecutter.camelcase_modelname}}Tokenizer, TF{{cookiecutter.camelcase_modelname}}ForConditionalGeneration
            >>> import tensorflow as tf
