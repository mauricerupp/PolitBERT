...
class ModelArguments:
    ...
    use_auth_token: bool = field(
        default=False,
        metadata={
            "help": "Will use the token generated when running `transformers_local-cli login` (necessary to use this script "
            "with private models)."
        },
    )
{% endif %}
...
def main():
    # See all possible arguments in src/transformers_local/training_args.py
